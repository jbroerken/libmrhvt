...
#ifndef MRH_DefaultCompare_h
#define MRH_DefaultCompare_h
...
namespace MRH_StringCompareDC
{
    ...
    /**
     *  Check if two supplied strings are matching.
     *
    ...
    bool IsSimilar(std::string const& s_Compare, std::string const& s_With) noexcept;
    ...
    bool ContainedIn(std::string const& s_Contained, std::string const& s_In) noexcept;
    
};

#endif /* MRH_DefaultCompare_h */
